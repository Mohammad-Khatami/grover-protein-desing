...
#######
#inv_d=[2.3,0.4,1.2]
#inv_d=[0.2694840278181478, 0.30178582014172844, 1.2038585308576921]
inv_d=[0.2204869318512118, 0.16881394379731987, 0.45454545454545453]
t=0
for i in range (len(inv_d)-2):
    t=t+inv_d[i]
thrsh=t*4.3*.80
####### H-gates!
...
result = execute(qc_dist, matrix_simulator, shots=1000000).result()
data=result.get_counts()
print('1000000 shots in {} s'.format(result.time_taken))
print('Ennergy thresh was {} E'.format(thrsh))
#print (data)
with open('2r_1c_4i5d-R1-80.txt', 'w') as file:
    file.write(str(data))
